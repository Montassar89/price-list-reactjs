...
class Price extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
  ...
  render() {
    ...
    return (
      ...
      React.createElement("img", { src: "./undraw_contract_uy56.svg",width: "400",height:"226" }),
      ...
      React.createElement("div", { className: "price__item" + (product.dayPrice ? ' day-price' : '') }, product.name)),


      React.createElement("div", { className: "price" + (product.dayPrice ? ' day-price' : '') }, "\u20AC ", product.price, ".", React.createElement("sup", null, "00"))))),
